    ...
    return (
      ...
      <div className="row g-3 my-2">
        <div className="col-md-3 p-1">
          <div className="card p-3 bg-secondary shadow-sm d-flex justify-content-around align-items-center rounded">
            <div>
              <h3 className="fs-2"><FcExpired></FcExpired> Imp Notice</h3>
              <p className="fs-5">CS & IT annual dinner registration start.</p>
            </div>
          </div>
        </div>
        <div className="col-md-3 p-1">
          <div className="card p-3 bg-warning shadow-sm d-flex justify-content-around align-items-center rounded">
            <div>
        ...
        <div className="col-md-3 p-1">
          <div className="card p-3 bg-primary shadow-sm d-flex justify-content-around align-items-center rounded">
            <div>
